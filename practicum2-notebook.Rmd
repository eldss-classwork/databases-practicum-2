...
findMaxRow <- function(file, stopKeyValue) {
...
rows <- findMaxRow(titleBasics, stopTconst)
...
```{r}
rows <- findMaxRow(titleAkas, stopTconst)
...
```{r}
# rows <- findMaxRow(titleRatings, stopTconst)
