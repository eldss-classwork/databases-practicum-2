...
df.akas <- read.table("data/title.akas.tsv.gz", sep='\t', quote = "\"", fill=TRUE, header=TRUE, encoding="UTF-8")
df.nBasics <- read.table("data/name.basics.tsv.gz", sep='\t', quote = "\"", fill=TRUE, header=TRUE, encoding="UTF-8")
df.tBasics <- read.table("data/title.basics.tsv.gz", sep='\t', quote = "\"", fill=TRUE, header=TRUE, encoding="UTF-8")
