...
```
```{r}
barplot(timing, names.arg=labels, ylab="Timing", col = rainbow(20), ylim=range(pretty(c(timing))))
```

```{r}
barplot(timing, names.arg=labels, ylab="Timing", col = rainbow(20), ylim=range(pretty(c(0,timing))))
```
```{r}
...
barplot(Values, names.arg = labels, ylab = "Timing", col = colors, ylim=range(pretty(c(axisRange))), beside=TRUE)

# Add the legend to the chart
legend("top", actors, cex = 0.7, fill = colors, horiz = TRUE)
```

```{r}
# Create the bar chart
barplot(Values, names.arg = labels, xlab = "Timing", col = colors, xlim=range(pretty(c(0, axisRange))), beside=TRUE, horiz=TRUE)
...
```{r}
# Create the bar chart
barplot(Values, names.arg = labels, xlab = "Timing", col = colors, xlim=c(0.0010008, 0.0010035), beside=TRUE, horiz=TRUE, xpd=FALSE)

# Add the legend to the chart
legend("topright", actors, cex = 0.7, fill = colors)

text(0.00100106, plt, Values, cex=0.8, pos=4)
```


```{r}
# Create the bar chart
barplot(Values, names.arg = labels, xlab = "Timing", col = colors, xlim=range(pretty(c(min(axisRange), max(axisRange)))), beside=TRUE, horiz=TRUE, xpd=FALSE)
