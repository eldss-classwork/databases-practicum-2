...
```{r}
# Create the bar chart
barplot(Values, names.arg = labels, xlab = "Timing", col = colors, xlim=range(pretty(c(0.0010008, 0.0010035))), beside=TRUE, horiz=TRUE, xpd=FALSE)

# Add the legend to the chart
legend("top", actors, cex = 0.7, fill = colors)

text(0.0010005, plt, Values, cex=0.8, pos=4)
```
