...
```{sql connection=conn}
SELECT tconst FROM Media WHERE format_id=2 LIMIT 5;
```

```{sql connection=conn}
SELECT * FROM Episodes JOIN (SELECT tconst FROM Media WHERE format_id=2 LIMIT 5) series ON series.tconst=Episodes.parentTconst;
```
